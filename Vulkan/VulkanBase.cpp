...
const std::string MODEL_PATH = "geo/viking_room.obj";
const std::string TEXTURE_PATH = "geo/viking_room.png";
...
void VulkanBase::createTextureSampler()
{
    ...
    samplerInfo.maxAnisotropy = 1.0f; // Double Attribute
...
QueueFamilyIndices VulkanBase::findQueueFamilies(VkPhysicalDevice device) {
    ...
    for (const auto& queueFamily : queueFamilies) {
        ...
        if (&presentSupport == nullptr) std::cerr << "no" << std::endl;
        if (presentSupport) {
